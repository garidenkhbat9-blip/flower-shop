...
import { AdminDialogProvider } from "@/context/AdminDialogContext";
import { 
  LayoutDashboard, 
  ShoppingBag, 
  Flower2, 
          ...
          <div className="flex flex-col h-full justify-between">
            <div>
              <div className="h-20 flex items-center justify-between px-8 border-b border-gray-50">
                <h1 className="text-xl font-playfair font-semibold tracking-tight text-[#1A1A1A]">Admin Panel</h1>
                {/* Хаах товч (Mobile-д) */}
                <button onClick={() => setIsSidebarOpen(false)} className="lg:hidden text-black"><X size={20} /></button>
              </div>
                    ...
                    <Link
                      ...
                      className={`flex items-center justify-between px-5 py-4 rounded-[2px] transition-all text-[10px] uppercase tracking-[0.2em] ${
                        isActive
                          ...
                          : "text-black font-semibold hover:bg-[#FCFBF9]"
                      }`}
                    >
            ...
            <div className="p-6 border-t border-gray-50">
              <Link
                href="/"
                className="flex items-center gap-4 px-5 py-4 text-black hover:text-black font-semibold text-[10px] uppercase tracking-[0.2em] rounded-[2px] transition-colors"
              >
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-20 bg-white border-b border-black/[0.03] flex items-center justify-between px-6 lg:px-10 shrink-0 sticky top-0 z-30">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-lg md:text-xl font-playfair font-semibold text-black">
