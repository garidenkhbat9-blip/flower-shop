...
export default function MobileBottomNav() {
  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around items-center py-3 px-2 z-[70] text-[10px] font-bold text-gray-400 shadow-[0_-8px_20px_rgba(0,0,0,0.05)] print:hidden safe-area-pb">
        <Link
          href="/"
          onClick={() => setIsCategoryOpen(false)}
